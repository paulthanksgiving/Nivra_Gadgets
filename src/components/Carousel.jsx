    ...
    const SamplePrevArrow = (props) => {
        ...
        return (
            <div onClick={onClick} className={`arrow ${className}`} style={{zIndex:3}}>
                <ArrowLeft className='arrows' style={{...style, display: "block", borderRadius:"50px", background:"#f53347" , color:"white" , position:"absolute", padding:"2px", left:"50px"}} />
            </div>
        )
    }
    const SampleNextArrow = (props) => {
        ...
        return (
            <div onClick={onClick} className={`arrow ${className}`}>
                <ArrowRight className='arrows' style={{...style, display: "block", borderRadius:"50px", background:"#f53347" , color:"white" , position:"absolute", padding:"2px", right:"50px"}} />
            </div>
        )
    }
